...
def get_user() -> Union[dict, None]:
    """ Function returning a user dictionary or
...
@app.before_request
def before_request():
    """ Operations happening before a request """
    user = get_user()
    g.user = user
...
def get_timezone() -> str:
    """
    Function that :-
    a) finds timezone parameter in URL parameters
    b) finds time zone from user settings
    c) defaults to UTC
    """
    try:
